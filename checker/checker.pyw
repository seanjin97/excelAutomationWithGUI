...
#     excel.loc[excel['Branch Code'] == "000", 'Error'] = 'yes'
    excel[["Bank Name", "Bank Code", "Branch Code", "AN", "BAH","N", "Num", "Masked_Num", "Bank Key (Bank and Branch Code)"]] = excel[["Bank Name", "Bank Code", "Branch Code", "AN", "BAH","N", "Num", "Masked_Num", "Bank Key (Bank and Branch Code)"]].astype(str)
    return excel 
...
def workingdf(PATH, checked):
    ...
    df[["Reference Document Number", "Vendor N1", "Bank Key", "Bank Account", "Amt in Doc Curr."]] = checked[["Masked_Num", "BAH", "Bank Key (Bank and Branch Code)", "AN", "Amount Disbursed \nto Member "]]
    return df
